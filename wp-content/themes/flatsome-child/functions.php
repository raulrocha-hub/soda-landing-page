...
function soda_perfeita_scripts() {
    // CSS da pasta css/
    wp_enqueue_style('bootstrap-css', get_stylesheet_uri() . '/css/bootstrap.css');
    wp_enqueue_style('root-css', get_stylesheet_uri() . '/css/_root.css');
    wp_enqueue_style('app-css', get_stylesheet_uri() . '/css/App.css');
    wp_enqueue_style('css2-css', get_stylesheet_uri() . '/css/css2.css');
    wp_enqueue_style('index-css', get_stylesheet_uri() . '/css/index.css');
    ...
    // JS
    wp_enqueue_script('bootstrap-js', get_stylesheet_uri() . '/assets/js/bootstrap.bundle.min.js', array('jquery'), '5.3.0', true);
    wp_enqueue_script('main-js', get_stylesheet_uri() . '/assets/js/main.js', array('jquery'), '1.0', true);
}
...
function meu_logotipo_login_personalizado() {
    ...
    <style type="text/css">
        body.login div#login h1 a {
            background-image: url(<?php echo get_stylesheet_uri(); ?>/imgs/logo.png);
            padding-bottom: 30px;
